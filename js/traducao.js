document.addEventListener('DOMContentLoaded', function() {
    const translations = {
        pt: {
            ...
            project2Title: "Análise de Proteção e Adoção de Animais",
            ...
            project3Title: "Web Scraping",
            project3Desc: "Script de web scraping desenvolvido para extrair informações de eventos acadêmicos e científicos da área de tecnologia. Automatiza a coleta de dados, organizando essas informações de forma estruturada para facilitar consultas, análises ou integração com outras bases.",
            demo: "Demo",
            codigo: "Código",
        ...
        en: {
            ...
            project2Title: "Animal Protection and Adoption Analysis",
            ...
            project3Title: "Web Scraping",
            project3Desc: "Web scraping script developed to extract information about academic and scientific events in the field of technology. It automates data collection, organizing the information in a structured way to facilitate queries, analysis, or integration with other databases.",
            demo: "Demo",
            codigo: "Code",
            caseStudy: "Case Study",
            notebook: "Notebook",
        ...
        es: {
            ...
            project2Title: "Análisis de Protección y Adopción de Animales",
            ...
            project3Title: "Web Scraping",
            project3Desc: "Script de web scraping desarrollado para extraer información sobre eventos académicos y científicos en el área de tecnología. Automatiza la recopilación de datos, organizando la información de forma estructurada para facilitar consultas, análisis o integración con otras bases de datos.",
            demo: "Demo",
            codigo: "Código",
    ...
    const languageOptions = languageDropdown ? languageDropdown.querySelectorAll('a') : [];
    ...
    function updateTranslations() {
        ...
        // Update navbar links safely
        const navLinks = document.querySelectorAll('.nav-links a');
        if (navLinks.length >= 6) {
            navLinks[0].textContent = translations[currentLang].sobre || "Sobre";
            navLinks[1].textContent = translations[currentLang].experiencia || "Experiência";
            navLinks[2].textContent = translations[currentLang].projetos || "Projetos";
            navLinks[3].textContent = translations[currentLang].formacao || "Formação";
            navLinks[4].textContent = translations[currentLang].habilidades || "Habilidades";
            navLinks[5].textContent = translations[currentLang].contato || "Contato";
        }
    }
    ...
    languageOptions.forEach(option => {
        option.addEventListener('click', (e) => {
            ...
            // Update main button with new language
            if (languageBtn) {
                languageBtn.innerHTML = `<i class="fas fa-globe"></i> ${currentLang.toUpperCase()}`;
            }

            // Mark selected language with check
